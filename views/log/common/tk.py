...
class Application(Frame):
    ...
    def window_init(self):
        self.master.title('welcome to testing system')
    ...
    def createWidgets(self):
        ...
        self.titleLabel=Label(self.fm1,text="testing system",font=('微软雅黑',64),fg = "white",bg='black')
...
#        self.nextVideoImg= ImageTk.PhotoImage(file = '/home/hl/Desktop/lovelyqian/nextVideo.png') 
        ...
        self.nextVideoButton=Button(self.fm2_right,image='',text='next video',bg='black',command=self.start_play_video_thread)
        ...
        initIamge= PngImagePlugin.PngImageFile(file = '/home/jun/Firefox_wallpaper.png')#ImageTk.PhotoImage(load)  
